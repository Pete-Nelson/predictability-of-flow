...
# I usually rely on joins to get WYT data into my data frames. However, if you really wanted to have a function that returns a wyt classification for a date input, I’ve written one here: https://github.com/trinhxuann/deltadata/blob/93e087faa11ce634e62a9402a7a8c4f5f0346758/R/pullWyt.R#L84-L115. Note that it does rely on the function before it, pullWyt(), for the latest DWR wyt classification table.

# I’m still developing the package, so there may be bugs. You can install it and use these functions knowing that or feel free to take these functions for your own package/use (these functions should be bug free).
